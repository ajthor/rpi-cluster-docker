docker:
  images:
    ...
    - base:
      - name: rpi-cluster/alpine

    - alpine:
      - name: rpi-cluster/alpine
      - ext_name: resin/raspberrypi3-alpine
      - tag: 3.5.2
    ...
    - raspbian:
      - name: rpi-cluster/resin/rpi-raspbian

    - node:
      - name: rpi-cluster/node
      - ext_name: resin/raspberrypi3-alpine-node
      - tag: 7.7.3
    ...
    - golang:
      - name: rpi-cluster/golang
      - ext_name: resin/raspberrypi3-alpine-golang
      - tag: 1.8
    ...
    - registry:
      - name: rpi-cluster/registry
      - ext_name: vdavy/registry-arm
      - tag: 2.6.1
